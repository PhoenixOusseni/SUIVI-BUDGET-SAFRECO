    ...
    <div class="container-fluid px-3 pb-4">
        ...
        <div class="page-hero">
            <div class="d-flex align-items-start justify-content-between flex-wrap gap-2">
                ...
                <a href="{{ route('gestion_realisations.index') }}" class="hero-badge text-decoration-none text-white">
            ...
            <div class="form-card-body">
                <form action="{{ route('gestion_realisations.store') }}" method="POST">
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-5">
                            <label for="ligne_budget_id" class="form-label">Ligne budgétaire <span
                        ...
                        <div class="col-md-2">
                            ...
                            <select name="year" id="year" class="form-select">
                                ...
                                @foreach ($years as $y)
                                    <option value="{{ $y }}" {{ (int) $current === (int) $y ? 'selected' : '' }}>
                                        {{ $y }}</option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="p-3 mb-4"
                        style="background:var(--surface); border-radius:10px; border:1px solid var(--border);">
                        <div class="row g-3">
                            @foreach ($months as $num => $label)
                                <div class="col-md-3">
                                    <label class="form-label">{{ $label }}</label>
                                    <input type="number" step="0.01" min="0" name="months[{{ $num }}]"
                                        class="form-control"
                    ...
                    <div class="d-flex gap-2">
                        <button type="submit" class="btn-primary-custom"><i class="fas fa-save"></i> Enregistrer la
                            réalisation</button>
                    </div>
                </form>
            </div>
