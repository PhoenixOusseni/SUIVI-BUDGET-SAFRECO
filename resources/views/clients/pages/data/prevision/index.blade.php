...
@section('content')
    <div class="container-fluid">
        <div class="text-center mb-3">
            <h4 class="page-title">LISTE DES PREVISIONS</h4>
        </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <div class="col-md-6">
                        {{-- Filters --}}
                        <form method="GET" action="{{ route('gestion_previsions.index') }}" class="row g-2 mb-4">
                            <div class="col-auto">
                ...
                <div class="table-responsive" style="max-height:70vh; overflow:auto;">
                    <table class="table table-bordered table-hover table-striped table-sm table-exec align-middle mb-0"
                        ...
                        <tbody>
                            ...
                            @empty
                                <tr>
                                    <td colspan="{{ 2 + count($months) + 1 }}">Aucune prévision enregistrée pour l'année
                                        {{ $year }}.</td>
                                </tr>
                            @endforelse
                        </tbody>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="importModalLabel">Importer des prévisions</h5>
