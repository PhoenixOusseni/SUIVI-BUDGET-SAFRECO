...
<div class="container-fluid px-3 pb-4">
    ...
    @if ($errors->any())
        <div class="error-banner mb-4"><ul>@foreach ($errors->all() as $error)<li>{{ $error }}</li>@endforeach</ul></div>
    @endif
            ...
            <div class="form-card">
                <div class="form-card-body">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            <div style="font-size:1.2rem; font-weight:700; color:var(--blue);">{{ $user->nom }} {{ $user->prenom }}</div>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content" style="border-radius:14px; border:none; box-shadow:0 8px 32px rgba(0,61,130,.15);">
            <div class="modal-header modal-header-blue">
                <h5 class="modal-title"><i class="fas fa-edit me-2"></i>Modifier mon profil</h5>
