                ...
                <div class="form-card h-100">
                    ...
                    <div class="form-card-body">
                        <form action="{{ route('gestion_code_budgets.store') }}" method="POST">
                            ...
                            <div class="mb-3">
                                <label for="rubrique_id" class="form-label">Rubrique <span
                                ...
                                <select class="form-select" id="rubrique_id" name="rubrique_id" required>
                                    ...
                                    @foreach ($rubriques as $rubrique)
                                        <option value="{{ $rubrique->id }}">{{ $rubrique->code }} -
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="intitule" name="intitule"
                                    placeholder="Entrez l'intitulé" required>
                            </div>
                            <div class="mb-3">
                                            ...
                                            <div class="action-group">
                                                ...
                                                <form action="{{ route('gestion_code_budgets.destroy', $codeBudget->id) }}"
                                                    ...
                                                    <button type="submit" class="btn-danger-custom"
                                                        onclick="return confirm('Supprimer ce code budgétaire ?')"><i
