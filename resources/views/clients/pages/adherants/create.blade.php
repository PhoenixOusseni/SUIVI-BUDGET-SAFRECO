            ...
            <form action="{{ route('gestion_adherants.store') }}" method="POST">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="nom_adherant" name="nom_adherant" value="{{ old('nom_adherant') }}" required>
                    </div>
                    <div class="col-md-6">
                        <label for="contact_adherant" class="form-label">Contact</label>
                        <input type="text" class="form-control" id="contact_adherant" name="contact_adherant" value="{{ old('contact_adherant') }}">
                    </div>
                    <div class="col-md-6">
                        <label for="email_adherant" class="form-label">Email</label>
                        <input type="email" class="form-control" id="email_adherant" name="email_adherant" value="{{ old('email_adherant') }}">
                    </div>
                </div>
