...
@section('content')
    <div class="container mt-3 text-center">
        <h1 class="mb-2 page-title">Suivi des Fournisseurs</h1>
        <p>Bienvenue dans la section de suivi des fournisseurs. Ici, vous pouvez suivre et gérer vos fournisseurs
            efficacement.</p>
        <!-- Ajoutez ici le contenu spécifique au suivi des fournisseurs -->
    </div>
            ...
            <div class="card h-100">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h5 class="card-title text-success mb-0">Etat des Engagements</h5>
                        ...
                        <tbody>
                            @foreach ($engagements as $engagement)
                                <tr>
                                    ...
                                    <td>{{ $engagement->date_depot ? \Carbon\Carbon::parse($engagement->date_depot)->format('d/m/Y') : '' }}
                                    </td>
                                    <td>{{ number_format($engagement->montant, 0, ',', ' ') }}</td>
                                    <td>{{ $engagement->j_1 }}</td>
                                    <td>{{ $engagement->j_2 }}</td>
                                    <td>{{ $engagement->j_3 }}</td>
                                    <td>{{ $engagement->fournisseur ? $engagement->fournisseur->nom_fournisseur : 'N/A' }}
                                    </td>
                                    <td>
                                        @if ($engagement->piece_joint)
                                            <a href="{{ asset('storage/' . $engagement->piece_joint) }}" target="_blank"
    ...
    <div class="modal fade" id="addEngagementModal" tabindex="-1" aria-labelledby="addEngagementModalLabel"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form method="POST" action="{{ route('engagement.gestion_engagements.store') }}"
                    ...
                    <div class="modal-body">
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <label for="date_depot" class="small">Date de depot <span
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control" id="montant" name="montant"
                                    placeholder="Montant de l'engagement" required>
                            </div>
                            <div class="col-md-6">
                                <label for="fournisseur_id" class="small">Fournisseur <span
                                        class="text-danger">*</span></label>
                        ...
                        <div class="mb-3">
                            <label for="piece_joint" class="small">Piece jointe</label>
                            <input type="file" class="form-control" id="piece_joint" name="piece_joint"
