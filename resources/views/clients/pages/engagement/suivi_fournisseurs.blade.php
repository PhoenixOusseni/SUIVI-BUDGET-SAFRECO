...
<div class="container-fluid px-3 pb-4">
    ...
    <div class="page-hero">
        <div class="d-flex align-items-start justify-content-between flex-wrap gap-2">
            <div>
                <p class="hero-title"><i class="fas fa-chart-line me-2"></i>Suivi des Fournisseurs</p>
                <p class="hero-sub">État et suivi des engagements par fournisseur</p>
            </div>
    ...
    <div class="table-card">
        <div class="table-card-header">
            ...
            <div>
                <p class="tch-title">État des engagements</p>
